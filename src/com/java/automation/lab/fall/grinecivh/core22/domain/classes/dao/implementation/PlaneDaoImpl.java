...
public class PlaneDaoImpl<T> implements PlaneDao {
    ...
    public PlaneDaoImpl(List<CargoPlane> cp, List<ShortDistancePlane> sdp, List<MediumDistancePlane> mdp,
    ...
    public boolean equals(Object o) {
        ...
        PlaneDaoImpl that = (PlaneDaoImpl) o;
